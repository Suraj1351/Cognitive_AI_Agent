...
class ChatSection(QWidget):
    def __init__(self):
        ...
        movie = QMovie(GraphicsDirectoryPath('Son.gif'))
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        # Status label
        self.label = QLabel("")
        self.label.setStyleSheet("color: white; font-size:16px; margin-top: -30px; border: none;")
...
from PyQt5.QtWidgets import (
    ...
    QLineEdit, QGridLayout, QBoxLayout, QVBoxLayout, QHBoxLayout,
